...
This version can be specified in the configuration with the [`import/node-version` setting](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/README.md#importnode-version).
