...
The different from [`vue/no-shared-component-data`](https://github.com/vuejs/eslint-plugin-vue/tree/refs/tags/master/docs/rules/no-shared-component-data.md) is the root instance being also disallowed.
...
- [Test source](https://github.com/vuejs/eslint-plugin-vue/blob/master/tests/lib/rules/no-deprecated-data-object-declaration.test.ts)
