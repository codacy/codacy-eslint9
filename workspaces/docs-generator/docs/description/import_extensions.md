...
This is especially troublesome if you have import specifiers that [look like externals or builtins](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/docs/rules/order.md#how-imports-are-grouped).
...
> \[!NOTE]
>
> `pathGroupOverrides` is inspired by [`pathGroups` in `'import/order'`](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/docs/rules/order.md#pathgroups) and shares a similar interface.
