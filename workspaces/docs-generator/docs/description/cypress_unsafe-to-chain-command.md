...
If [Typed Linting](https://github.com/cypress-io/eslint-plugin-cypress/tree/master/README.md#typed-linting) is enabled, this rule also catches unsafe chaining even when the Cypress chain was started from a helper function.
