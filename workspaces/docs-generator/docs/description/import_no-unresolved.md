...
See [settings](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/README.md#settings) for customization options for the resolution (i.e.
...
If you are using Webpack, see the section on [resolvers](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/README.md#resolvers).
...
To suppress errors from files that may not be properly resolved by your [resolver settings](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/README.md#resolver-plugins), you may add an `ignore` key with an array of `RegExp` pattern strings:
...
## Further Reading
 ...
 - [Resolver plugins](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/README.md#resolvers)
