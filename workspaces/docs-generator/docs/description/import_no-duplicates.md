...
If the core ESLint version is good enough (i.e. you're _not_ using Flow and you _are_ using [`import/extensions`](https://github.com/import-js/eslint-plugin-import/tree/refs/tags/main/docs/rules/extensions.md)), keep it and don't use this.
